...
const App = () => {
  ...
  const resetTimer = () => {
    ...
    // Triggers Game Over after 60 seconds of inactivity
  ...
  return (
    <div className="min-h-screen w-full bg-gray-900 p-8 selection:bg-yellow-400 selection:text-black relative overflow-x-hidden" 
        ...
        <main className="mt-12">
          {currentView === 'home' && (
            <div className="text-center text-cyan-400 mt-20 animate-pulse leading-loose">
              INSERT COIN OR SELECT STAGE <br/><br/>
